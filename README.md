...
This is a prototype to test the delegation journey of the service. A user can delegate access to an authorised person - a financial advisor or a MaPS guider.
